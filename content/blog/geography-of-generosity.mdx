...
ogImage: "/posts/geography/geography-bar-chart.png"
---
...
![Figure 1.1: Histogram of Raw Tip Percentage (Skewed)](/posts/geography/histogram-raw-tip-pct.png)
...
![Figure 1.2: Histogram of Log-Transformed Tip Percentage (Normal)](/posts/geography/histogram-log-tip-pct.png)
...
![Figure 2.1: Scatter Plot of Average Tip vs. Neighborhood Income](/posts/geography/scatter-tip-vs-income.png)
...
![Figure 3.1: Bar Chart of Total Trips by Day of Week](/posts/geography/bar-trips-by-day.png)

![Figure 3.2: Boxplot of Tip Percentage by Day of Week](/posts/geography/boxplot-tip-by-day.png)
...
![Figure 3.3: Heatmap of Tip Percentage vs. Fare](/posts/geography/heatmap-tip-vs-fare.png)
...
![Figure 3.4: Scatter Plot of Fare vs. Trip Duration](/posts/geography/scatter-fare-vs-duration.png)
...
![Figure 4.1: Residuals vs. Fitted Values Plot](/posts/geography/residuals-vs-fitted.png)

![Figure 4.2: Normal Q-Q Plot of Residuals](/posts/geography/qq-plot.png)
...
![The Geography of Generosity Bar Chart](/posts/geography/geography-bar-chart.png)
...
![Figure B.4: R Studio environment showing all data frames and objects used in the analysis](/posts/geography/dataframes-screenshot.png)
...
![Histogram of raw tip percentage showing right skew](/posts/geography/histogram-raw-tip-pct.png)

**Figure E.2:** Histogram of Log-Transformed Tip Percentage (Normalized)

![Histogram of log-transformed tip percentage showing normal distribution](/posts/geography/histogram-log-tip-pct.png)

**Figure E.3:** Scatter Plot — Average Tip Percentage vs. Estimated Neighborhood Income

![Scatter plot of average tip percentage versus estimated neighborhood income](/posts/geography/scatter-tip-vs-income.png)

**Figure E.4:** Bar Chart — Total Trips by Day of the Week

![Bar chart of total trips by day of the week](/posts/geography/bar-trips-by-day.png)

**Figure E.5:** Boxplot — Tip Percentage by Day of the Week

![Boxplot of tip percentage by day of the week](/posts/geography/boxplot-tip-by-day.png)

**Figure E.6:** Heatmap — Tip Percentage vs. Fare Amount

![Heatmap of tip percentage versus fare amount](/posts/geography/heatmap-tip-vs-fare.png)

**Figure E.7:** Scatter Plot — Fare vs. Trip Duration (Multicollinearity Check)

![Scatter plot of fare versus trip duration showing strong linear correlation](/posts/geography/scatter-fare-vs-duration.png)

**Figure E.8:** Bar Chart — The Geography of Generosity (Residuals)

![Bar chart of the geography of generosity showing top and bottom Chicago community areas by mean residual](/posts/geography/geography-bar-chart.png)

---

## Download the report

<a href="/posts/geography-of-generosity.pdf" download className="inline-flex items-center text-text font-medium hover:text-accent transition-colors">Download the full PDF (42 pages) →</a>
